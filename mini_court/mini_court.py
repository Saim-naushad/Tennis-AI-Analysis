...
class MiniCourt():
    ...
    def draw_background_rectangle(self, frame):
        ...
        cv2.rectangle(shapes, (self.start_x, self.start_y), (self.end_x, self.end_y), (223, 134, 85), cv2.FILLED)
        out = frame.copy()
    ...
    def calculate_weighted_mini_court_position(self, object_position, court_key_points, mini_court_key_points, previous_object_y=None, frame_time=None):
        ...
        court_height = court_ys[-1] - court_ys[0]  
        ...
        scaling_factor = 0.1 + 0.3 * (1 - net_proximity_factor)  
        ...
        if left_idx != right_idx:
            ...
            mini_court_x = left_mini_point[0] 
